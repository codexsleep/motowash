                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><img src='<?= base_url().$service['service_icon'];?>' width="30px"/></td>
                                                    <td><?= $service['service_description'];?></td>
                                                    <td><?= $service['service_status'];?></td>
                                                    <td>
                                                        <a href="<?= base_url();?>admin/service/edit/<?= $service['service_id'];?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                                        <a href="#" onClick="confirm_modal('<?= base_url();?>admin/service/hapus/<?= $service['service_id'];?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                                }
