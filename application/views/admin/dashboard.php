                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="mb-0"><img src="<?= base_url();?>assets/images/users/user-3.jpg" alt=""
                                        ...
                                        <table class="table table-hover table-centered table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="<?= base_url();?>assets/images/users/user-2.jpg" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="<?= base_url();?>assets/images/users/user-3.jpg" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="<?= base_url();?>assets/images/users/user-4.jpg" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="<?= base_url();?>assets/images/users/user-5.jpg" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="<?= base_url();?>assets/images/users/user-6.jpg" alt=""
                                        ...
                                        <ul class="conversation-list" data-simplebar style="max-height: 367px;">
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="<?= base_url();?>assets/images/users/user-2.jpg"
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="<?= base_url();?>assets/images/users/user-3.jpg"
                                            ...
                                            <li class="clearfix odd">
                                                ...
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
                                                        ...
                                                        <img src="<?= base_url();?>assets/images/small/img-1.jpg" alt="" height="48"
                                                            class="rounded mr-2">
                                                        <img src="<?= base_url();?>assets/images/small/img-2.jpg" alt="" height="48"
                                                            class="rounded">
                                                    </div>
                                                </div>
                                            </li>
