                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $produk['product_image'];?></td>
                                                    <td>
                                                        <a href="<?= base_url();?>admin/product/edit/<?= $produk['product_id'];?>" class="btn btn-warning btn-xs">Edit</a>
                                                        <a href="#" onClick="confirm_modal('<?= base_url();?>admin/product/hapus/<?= $produk['product_id'];?>');" class="btn btn-danger btn-xs">Hapus</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
